...
# CONFIGURATION
# We point directly to the /mcp endpoint configured in your server
SERVER_URL = "http://localhost:8089/mcp"
...
def get_job_events(job_id):
    ...
    # Connect in read-only mode just to be safe, though not strictly required
    ...
    try:
        async with Client(SERVER_URL) as client:
            ...
            for _ in range(10):
                ...
                # Criteria for success: We saw submission AND completion (clean or finish)
        ...
        print(f"\n❌ Client Error: {e}")
        print("   Make sure the server is running with: python -m flux_mcp_server.server")
